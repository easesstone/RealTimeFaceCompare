...
object ClusteringNew {
  ...
  def main(args: Array[String]) {
    ...
    val joined = idPointDS.rdd.zipWithIndex().cartesian(idPointDS.rdd.zipWithIndex())
    ...
    val numFilter = numPerUrl.filter(_._3>timeCount).foreach(println(_))
...
*/
  ...
  def dataSetSimilarity(list1: List[String], list2: List[String]) = {

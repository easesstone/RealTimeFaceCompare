...
if [ ! -e ${CLUSTER_LIB_DIR}/${FTPSERVER_CORE_VERSION} ];then
    echo "${CLUSTER_LIB_DIR}/${FTPSERVER_CORE_VERSION} does not exit!"
    exit 0
fi
...
if [ ! -e ${CLUSTER_LIB_DIR}/${ROCKETMQ_CLIENT_VERSION} ];then
    echo "${CLUSTER_LIB_DIR}/${ROCKETMQ_CLIENT_VERSION} does not exit!"
    exit 0
fi
if [ ! -e ${CLUSTER_LIB_DIR}/${ROCKETMQ_COMMON_VERSION} ];then
    echo "${CLUSTER_LIB_DIR}/${ROCKETMQ_COMMON_VERSION} does not exit!"
    exit 0
fi
if [ ! -e ${CLUSTER_LIB_DIR}/${ROCKETMQ_REMOTING_VERSION} ];then
    echo "${CLUSTER_LIB_DIR}/${ROCKETMQ_REMOTING_VERSION} does not exit!"
    exit 0
fi
if [ ! -e ${CLUSTER_LIB_DIR}/${FASTJSON_VERSION} ];then
    echo "${CLUSTER_LIB_DIR}/${FASTJSON_VERSION} does not exit!"
    exit 0
fi
...
${CLUSTER_LIB_DIR}/${FTPSERVER_CORE_VERSION},\
${CLUSTER_LIB_DIR}/${ROCKETMQ_CLIENT_VERSION},\
${CLUSTER_LIB_DIR}/${ROCKETMQ_COMMON_VERSION},\
${CLUSTER_LIB_DIR}/${ROCKETMQ_REMOTING_VERSION},\
${CLUSTER_LIB_DIR}/${FASTJSON_VERSION},\

...
public class ListenerBeanDefinitionParser extends
    ...
    private final Logger LOG = LoggerFactory
            .getLogger(org.apache.ftpserver.config.spring.ListenerBeanDefinitionParser.class);
    ...
    protected void doParse(final Element element,
        ...
        Element dataConElm = SpringUtil.getChildElement(element,
                org.apache.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "data-connection");
        ...
        Element blacklistElm = SpringUtil.getChildElement(element,
                org.apache.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "blacklist");
        ...
        Element remoteIpFilterElement = SpringUtil.getChildElement(element,
                org.apache.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "remote-ip-filter");
    ...
    private SslConfiguration parseSsl(final Element parent) {
        Element sslElm = SpringUtil.getChildElement(parent,
                org.apache.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "ssl");

        if (sslElm != null) {
            SslConfigurationFactory ssl = new SslConfigurationFactory();

            Element keyStoreElm = SpringUtil.getChildElement(sslElm,
                    org.apache.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "keystore");
            if (keyStoreElm != null) {
            ...
            Element trustStoreElm = SpringUtil.getChildElement(sslElm,
                    org.apache.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "truststore");
    ...
    private DataConnectionConfiguration parseDataConnection(
        ...
        if (element != null) {
            ...
            Element activeElm = SpringUtil.getChildElement(element,
                    org.apache.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "active");
            if (activeElm != null) {

...
public class LocalFtpServerFactory extends FtpServerFactory implements Serializable {
    ...
    public LocalFtpServerContext getLocalFtpServerContext() {
        return localFtpServerContext;
    }

    public void setLocalFtpServerContext(LocalFtpServerContext localFtpServerContext) {
        this.localFtpServerContext = localFtpServerContext;
    }
}

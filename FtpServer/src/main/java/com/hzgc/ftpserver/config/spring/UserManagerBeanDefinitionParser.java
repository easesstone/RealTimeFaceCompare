...
import com.hzgc.ftpserver.usermanager.*;
...
public class UserManagerBeanDefinitionParser extends
    ...
    protected void doParse(final Element element,
        ...
        if (factoryClass == PropertiesUserManagerFactory.class) {
            ...
            Element dsElm = com.hzgc.ftpserver.config.spring.SpringUtil.getChildElement(element,
                    FtpServerNamespaceHandler.FTPSERVER_NS, "data-source");

            // schema ensure we get the right type of element
            Element springElm = com.hzgc.ftpserver.config.spring.SpringUtil.getChildElement(dsElm, null, null);
            Object o;

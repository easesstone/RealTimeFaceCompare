...
import com.hzgc.ftpserver.DataConnectionConfiguration;
import com.hzgc.ftpserver.DataConnectionConfigurationFactory;
import com.hzgc.ftpserver.FtpServerConfigurationException;
import com.hzgc.ftpserver.ipfilter.IpFilterType;
import com.hzgc.ftpserver.ipfilter.RemoteIpFilter;
import com.hzgc.ftpserver.listener.ListenerFactory;
import com.hzgc.ftpserver.ssl.SslConfiguration;
import com.hzgc.ftpserver.ssl.SslConfigurationFactory;
...
public class ListenerBeanDefinitionParser extends
    ...
    private final Logger LOG = LoggerFactory
            .getLogger(com.hzgc.ftpserver.config.spring.ListenerBeanDefinitionParser.class);
    ...
    protected void doParse(final Element element,
        ...
        Element dataConElm = SpringUtil.getChildElement(element,
                com.hzgc.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "data-connection");
        ...
        Element blacklistElm = SpringUtil.getChildElement(element,
                com.hzgc.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "blacklist");
        ...
        Element remoteIpFilterElement = SpringUtil.getChildElement(element,
                com.hzgc.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "remote-ip-filter");
    ...
    private SslConfiguration parseSsl(final Element parent) {
        Element sslElm = SpringUtil.getChildElement(parent,
                com.hzgc.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "ssl");

        if (sslElm != null) {
            SslConfigurationFactory ssl = new SslConfigurationFactory();

            Element keyStoreElm = SpringUtil.getChildElement(sslElm,
                    com.hzgc.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "keystore");
            if (keyStoreElm != null) {
            ...
            Element trustStoreElm = SpringUtil.getChildElement(sslElm,
                    com.hzgc.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "truststore");
    ...
    private DataConnectionConfiguration parseDataConnection(
        ...
        if (element != null) {
            ...
            Element activeElm = SpringUtil.getChildElement(element,
                    com.hzgc.ftpserver.config.spring.FtpServerNamespaceHandler.FTPSERVER_NS, "active");
            if (activeElm != null) {

...
function start_ftpserver()
{
    ...
    nohup java -server -Xms2g -Xmx4g  -XX:PermSize=512m -XX:MaxPermSize=512m  -classpath $CONF_DIR:$LIB_JARS com.hzgc.ftpserver.kafka.ftp.KafkaOverFtpServer > ${LOG_FILE} 2>&1 &
}

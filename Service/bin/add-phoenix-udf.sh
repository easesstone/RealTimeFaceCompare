...
## Filename:     add-phoenix-udf.sh
## Description:  向phoenix中添加并注册facecomp函数
## Author:       lidiliang
## Created:      2018-03-22
################################################################################
...
## phoenix_home
PHOENIX_HOME=${BIGDATA_CLUSTER_PATH}/Phoenix/phoenix
## hdfs udf  path
...
${PHOENIX_HOME}/bin/psql.py ${DEPLOY_DIR}/sql/phoenix-udf.sql
